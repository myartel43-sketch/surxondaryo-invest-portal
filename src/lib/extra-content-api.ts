...
export type MapItem = { id:string; title_uz:string; title_ru:string; title_en:string; title_zh:string; description_uz:string; description_ru:string; description_en:string; description_zh:string; latitude:number; longitude:number; address:string; category:string; is_published:boolean };
...
export const emptyMap=()=>({title_uz:"",title_ru:"",title_en:"",title_zh:"",description_uz:"",description_ru:"",description_en:"",description_zh:"",latitude:37.2242,longitude:67.2783,address:"",category:"Инвестиция объекти",is_published:true});
